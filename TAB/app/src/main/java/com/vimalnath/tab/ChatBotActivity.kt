...
import com.vimalnath.tab.fragments.adapter.AgentAdapter
...
class ChatBotActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Set OnClickListener to update the list and call dialogflow
        ...
        // Set OnClickLister for back button
        backBtn.setOnClickListener {

            startActivity(Intent(this@ChatBotActivity, MainActivity::class.java))
        }
    }
